...
public class RessourceControllerTest {
    ...
    void testUpdateRessource() throws Exception {
        ...
        mockMvc.perform(put("/api/cours/{coursId}/chapitres/{chapitreId}/ressources/{ressourceId}", coursId, chapitreId, ressourceId)
               .header("Authorization", "Bearer " + jwtToken)
               .contentType(MediaType.APPLICATION_JSON)
    ...
    void testDeleteRessource() throws Exception {
        ...
        mockMvc.perform(delete("/api/cours/{coursId}/chapitres/{chapitreId}/ressources/{ressourceId}", coursId, chapitreId, ressourceId)
               .header("Authorization", "Bearer " + jwtToken))
               .andExpect(status().isOk());
    }
